...
export default class DungeonGenerator {
  ...
  */
    addCoins(room) {
      ...
      switch (where) {
        case "top": this.addCoinsTop(room, width, height);break;
        case "bottom": this.addCoinsdBottom(room, width, height);break;
        case "left": this.addCoinsdLeft(room, width, height);break;
        case "right": this.addCoinsdRight(room, width, height);break;
        default: break;
      }
    }
