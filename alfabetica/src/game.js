...
export default class Game extends Phaser.Scene {
    ...
    preload () {
        ...
        let paramCircle = urlParams.get('circle') || "#f22c2e";
        paramCircle = parseInt(paramCircle.substring(1), 16)
        this.circleColor = '0x' + paramCircle.toString(16)
        this.highestScore = 1;
    ...
    create () {
        ...
        this.alphabetic = new Alphabetic();
        this.current = this.result = this.alphabetic.generateNext();
    ...
    addUI () {
        this.circleBack = this.add.circle(this.center_width, this.center_height + 8, 90, 0x000000).setAlpha(0.5);
        this.circle = this.add.circle(this.center_width, this.center_height, 90, this.circleColor);
        this.numberText = this.add.bitmapText(this.center_width, this.center_height - 5, "mainFont", this.current, 120).setOrigin(0.5).setTint(this.rectangleColor)
        this.addScore();
    }
    ...
    addScore () {
        ...
        this.hightScoreText1 = this.add.bitmapText(this.center_width, 16, "mainFont", "HIGH SCORE: " + this.highestScore, 20).setOrigin(0.5).setTint(this.textColor).setDropShadow(1, 1, 0xffffff, 0.7);
        ...
        this.scoreText2 = this.add.bitmapText(this.center_width, this.height - 32, "mainFont", "", 40).setOrigin(0.5).setTint(this.textColor).setDropShadow(1, 1, 0xffffff, 0.7);
    }
    ...
    showAnimation() {
        ...
        this.buttonTween = this.tweens.add({
            targets: [this.circle, this.numberText],
            y: "+=8",
            duration: 150,
            yoyo: true,
        });
...
/*         if (Phaser.Input.Keyboard.JustDown(this.cursor.down)) {
    ...
    generateNextOperation () {
        ...
        this.numberText.setText(this.current);
        this.result = this.alphabetic.generateNext();
    ...
    showShame (playerName) {
        const rants = ["You're a disgrace", "Shame on you", "You dishonor us all", "You're a disappointment", "You're a failure"]
