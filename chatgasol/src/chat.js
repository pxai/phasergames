    ...
    init () {
        ...
        this.client.on("message", (channel, tags, message, self) => {
            ...
            if (message.trim().startsWith("!")) {
                // if(self) return;
                [speed, angle] = messageParts;
                this.sendAction(channel, `${tags.username} attacks ${speed} ${angle}`);
                this.scene.attack(tags.username, speed.substring(1), angle);
            }
        ...
        this.client.on("chat", async (channel, user, message, self) => {
            ...
            if (message.trim().startsWith("!")) {
                ...
                this.scene.attack(username, speed.substring(1), angle);
            }
        });
    }
