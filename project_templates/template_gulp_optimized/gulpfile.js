...
function assets () {
    return src(["./assets/**/*","!./assets/html/*.html","!./assets/images/*.*"])
...
exports.build = build;
exports.production = series(clean, html, vendor, assets, packImages, buildProd);
exports.default = series(clean, parallel(html, vendor, assets, packImages, build), parallel(browserSync, watchIt));
