export default class Transition extends Phaser.Scene {
    ...
    create () {
        ...
        this.add.bitmapText(this.center_width, this.center_height + 70, "celtic", "Jump on cakes", 30).setOrigin(0.5)
        this.add.bitmapText(this.center_width, this.center_height + 120, "celtic", "to produce muffins!", 30).setOrigin(0.5)
