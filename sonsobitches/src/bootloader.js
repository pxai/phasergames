export default class Bootloader extends Phaser.Scene {
    ...
    preload () {
        ...
        this.load.on(
            ...
            function (value) {
                ...
                this.progressBar.fillStyle(0xf0d54a, 1);
        ...
        this.load.audio("hit", "assets/sounds/ghostdead.mp3");
        ...
        this.load.audio("health", "assets/sounds/health.mp3");
    ...
    createBars () {
        ...
        this.loadBar.fillStyle(0xE67A32, 1);
