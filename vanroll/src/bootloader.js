export default class Bootloader extends Phaser.Scene {
    ...
    preload () {
        ...
        this.load.on(
            ...
            function (value) {
                ...
                this.progressBar.fillStyle(0x4A9130, 1);
       ...
       /* Array(7).fill(0).forEach((_,i) => {
        ...
        this.load.spritesheet("plant", "assets/images/plant.png", { frameWidth: 32, frameHeight: 32 });

        this.load.image('ivy', 'assets/maps/ivy.png');
    ...
    createBars () {
        ...
        this.loadBar.fillStyle(0xA13647, 1);
