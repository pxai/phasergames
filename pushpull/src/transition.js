export default class Transition extends Phaser.Scene {
  ...
  */
    create () {
        const messages = [ "Tutorial", "Stage0", "Stage1", "Stage2", "Stage3",
            "Stage4", "Stage5", "Stage6", "Stage7", "Outro"
        ]
        ...
        this.add.bitmapText(this.center_width, this.center_height - 20, "mario", messages[this.number], 40)
            .setOrigin(0.5).setTint(0xa6f316).setDropShadow(2, 3, 0x75b947, 0.7);
        this.add.bitmapText(this.center_width, this.center_height + 20, "mario", "Ready?", 30)
            .setOrigin(0.5).setTint(0xa6f316).setDropShadow(2, 3, 0x75b947, 0.7);
