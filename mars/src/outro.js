...
The outro is similar to the Splash screen, but it has a different background and a different title. It also has a different music theme.
  */
    create () {
      ...
      this.title = this.add.bitmapText(this.center_width, this.center_height + 100, "pico", "MARSTRANDED", 60)
        .setTint(0x6b140b).setAlpha(0).setDropShadow(0, 4, 0x6b302a, 0.9).setOrigin(0.5)
      this.tweens.add({
          targets: this.title,
          alpha: {from: 0, to: 1},
          duration: 4000
