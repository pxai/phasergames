export default class Key extends Phaser.GameObjects.Container {
    constructor (scene, x, y, letter, callback) {
        ...
        this.square = new Phaser.GameObjects.Rectangle(this.scene, 64, 32, 58, 58, 0x618fc0).setOrigin(0.5).setAlpha(0)
        this.add(this.square);
        this.letterText = new Phaser.GameObjects.BitmapText(this.scene, 64, 32, "default", this.letter.toUpperCase(), 40).setOrigin(0.5)
    ...
    setListeners () {
        ...
        this.letterText.on('pointerdown', () => {
            ...
            this.letterText.setTint(0x618fc0)
