export default class Outro extends Phaser.Scene {
    ...
    showLine(text, y) {
        let line = this.introLayer.add(this.add.bitmapText(this.center_width, y, "pixelFont", text, 25).setTint(0x0eb7b7).setDropShadow(1, 2, 0xffffff, 0.7).setOrigin(0.5).setAlpha(0));
        this.tweens.add({
            targets: line,
            duration: 2000,
            alpha: 1
