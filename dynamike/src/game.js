...
export default class Game extends Phaser.Scene {
    ...
    createMap() {
      ...
      //this.layer1.setScale(0.75);
      //this.layer1.setScrollFactor(0.5);
      //this.layer1.setAlpha(0.5);
    }
    ...
    showPoints (x, y, score, color = 0xff0000) {
      let text = this.add.bitmapText(x + 20, y - 80, "wendy", "+"+score, 40).setDropShadow(2, 3, color, 0.7).setOrigin(0.5);
      this.tweens.add({
          targets: text,
          duration: 1000,
          alpha: {from: 1, to: 0},
   ...
   textUpdateEffect (textElement, color) {
    ...
    addPlayer() {
      ...
      const playerPosition = {x: 100, y: 100} //this.objectsLayer.objects.find( object => object.name === "player")
