export default class Splash extends Phaser.Scene {
    ...
    showTitle() {
        this.gameLogo1 = this.add.bitmapText(this.center_width - 1000, 100, "mario", "Power", 120).setOrigin(0.5).setTint(0xffffff).setDropShadow(3, 4, 0x75b947, 0.7);//.setTint(0xa6f316).setDropShadow(3, 4, 0x75b947, 0.7);
        this.gameLogo2 = this.add.bitmapText(this.center_width + 1000, 220, "mario", "Grid", 120).setOrigin(0.5).setTint(0xffe066).setDropShadow(2, 3, 0x693600, 0.7);
