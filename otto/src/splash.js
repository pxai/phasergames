export default class Splash extends Phaser.Scene {
    ...
    showLogo() {
        ...
        this.titleText1 = this.add.bitmapText(-200, 64, "pixelFont", "OT", 220).setOrigin(1, 0).setTint(0xDEA551)
        this.titleText2 = this.add.bitmapText(1200, 64, "pixelFont", "TO", 220).setOrigin(0, 0).setTint(0x518ADE)
    ...
    showInstructions() {
        this.add.bitmapText(this.center_width, 540, "pixelFont", "WASD/Arrows: move", 30).setOrigin(0.5).setTint(0x518ADE)
        this.add.sprite(this.center_width - 60, 610, "pello").setOrigin(0.5).setScale(0.5)
        this.add.bitmapText(this.center_width + 40, 610, "pixelFont", "By PELLO", 15).setOrigin(0.5).setTint(0x518ADE)
        this.space = this.add.bitmapText(this.center_width, 680, "pixelFont", "Press SPACE to start", 30).setOrigin(0.5).setTint(0xDEA551)
        this.tweens.add({
            targets: this.space,
            duration: 300,
            alpha: {from: 0, to: 1},
