export default class Water {
    constructor(scene){
        this.scene = scene;
        this.water = this.scene.add.rectangle(0, this.scene.height - 200, this.scene.width, 800, 0x008080).setAlpha(0.5).setOrigin(0).setScrollFactor(0, 1)


        this.surface = this.scene.add.rectangle(0, this.scene.height - 200, this.scene.width * 100, 4, 0x008888).setAlpha(0.5).setOrigin(0).setScrollFactor(0, 1)
